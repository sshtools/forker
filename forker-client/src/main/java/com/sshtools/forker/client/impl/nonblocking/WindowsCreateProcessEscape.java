...
class WindowsCreateProcessEscape {
	...
	public static void quote(StringBuilder buf, String arg) {
		...
		// Escape all the backslashes that appear before the final closing
		// quote.
		for (int j = 0; j < nPending; j++) {
			buf.append('\\');
		}
	...
	/**
	 * Given a string X, this function returns a string that, when passed
	 * through the Windows implementation of Java's
	 * {@link Runtime#exec(String[])} or {@link java.lang.ProcessBuilder}, will
	 * appear to the spawned process as X.
	 *
