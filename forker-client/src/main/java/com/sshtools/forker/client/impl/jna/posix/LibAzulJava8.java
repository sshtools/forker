...
public class LibAzulJava8 {
	static {
		...
		Java_java_lang_ProcessImpl_init(JNIEnv.CURRENT, NonBlockingBasePosixProcess.class);
	}
	 ...
	 */
	public static native int Java_java_lang_ProcessImpl_forkAndExec(JNIEnv jniEnv, Object process, int mode, Object helperpath,
