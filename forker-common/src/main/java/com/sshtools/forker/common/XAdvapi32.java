...
public interface XAdvapi32 extends Advapi32 {
	 ...
	 * @return status
	 */
	public boolean AllocateAndInitializeSid(SID_IDENTIFIER_AUTHORITY pIdentifierAuthority, byte bytSubAuthorityCount,
			int intSubAuthority0, int intSubAuthority1, int intSubAuthority2, int intSubAuthority3,
			int intSubAuthority4, int intSubAuthority5, int intSubAuthority6, int intSubAuthority7, Pointer pSid);
