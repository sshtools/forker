 ...
 */
public class EnqueueUnitJobStruct extends Struct {
    @Position(0)
    ...
    public EnqueueUnitJobStruct(UInt32 member0, DBusPath member1, String member2, DBusPath member3, String member4) {
