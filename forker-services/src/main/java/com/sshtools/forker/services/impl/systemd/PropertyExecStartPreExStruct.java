 ...
 */
public class PropertyExecStartPreExStruct extends Struct {
    @Position(0)
    ...
    public PropertyExecStartPreExStruct(String member0, List<String> member1, List<String> member2, UInt64 member3, UInt64 member4, UInt64 member5, UInt64 member6, UInt32 member7, int member8, int member9) {
