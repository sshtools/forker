 ...
 */
public class PropertyBindReadOnlyPathsStruct extends Struct {
    @Position(0)
    ...
    public PropertyBindReadOnlyPathsStruct(String member0, String member1, boolean member2, UInt64 member3) {
