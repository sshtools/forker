 ...
 */
public class PropertyAssertsStruct extends Struct {
    @Position(0)
    ...
    public PropertyAssertsStruct(String member0, boolean member1, boolean member2, String member3, int member4) {
