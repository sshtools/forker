 ...
 */
public class ListJobsStruct extends Struct {
    @Position(0)
    ...
    public ListJobsStruct(UInt32 member0, String member1, String member2, String member3, DBusPath member4, DBusPath member5) {
