 ...
 */
public class ListUnitsFilteredStruct extends Struct {
    @Position(0)
    ...
    public ListUnitsFilteredStruct(String member0, String member1, String member2, String member3, String member4, String member5, DBusPath member6, UInt32 member7, String member8, DBusPath member9) {
